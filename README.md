...
Make sure you have [Node.js](https://nodejs.org/en/download) installed on your computer. You will also need the **Expo Go** app installed on your physical mobile device.
...
_(Note: Always use `npx expo` or `npm start` rather than the old global `expo` command)._
